<template>
  <div class="playroom-mode min-h-screen bg-base-100">
    <SettingsNav />
    <div class="p-6">
      <div class="container mx-auto max-w-4xl">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            <h1 class="text-3xl font-bold text-secondary flex items-center gap-3">
              ...
              Playroom Experimental
            </h1>
            <p class="text-sm text-base-content/60 mt-1">
              Zona de pruebas - Interfaz experimental para nuevas ideas
            </p>
          </div>
        </div>
        ...
        <div class="alert alert-info mb-4">
          ...
          <span>Este es un entorno experimental. Puedes probar nuevas interfaces sin afectar el sistema principal.</span>
        </div>
        ...
        <div class="grid gap-6">
          ...
          <div class="flex justify-center">
            ...
            >
              ...
              {{ isGenerating ? 'Generando...' : 'Generar Jingle (Playroom)' }}
            </button>
          </div>
...
import { usePlayroomMode } from './composables/usePlayroomMode'
