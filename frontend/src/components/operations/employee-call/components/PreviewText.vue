      ...
      <div class="card-body p-6">
        ...
        >
          ...
          <p class="text-base-content/50 text-center text-sm max-w-xs">
            Completa el nombre y ubicación para ver cómo quedará el mensaje
          </p>
        </div>
...
import type { EmployeeCallPreviewResponse } from '../composables/useEmployeeCallAnnouncement'

const props = defineProps<{
  preview: EmployeeCallPreviewResponse | null
  loading: boolean
